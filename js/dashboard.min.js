angular.module("RDash", ["ui.bootstrap", "ui.router", "ngCookies", angularDragula(angular)]);
...
function MasterCtrl(e, t, o, s) { function n() { o.get("https://rashnk-tf.github.io/fieldmanager-ui/assets/data/objects.json").success(function (t) { console.log(t), e.objects = t }), o.get("assets/data/sections.json").success(function (t) { console.log(t), e.sections = t }) } var l = 992; e.getWidth = function () { return window.innerWidth }, e.$watch(e.getWidth, function (o, s) { o >= l ? angular.isDefined(t.get("toggle")) ? e.toggle = !!t.get("toggle") : e.toggle = !0 : e.toggle = !1 }), e.toggleSidebar = function () { e.toggle = !e.toggle, t.put("toggle", e.toggle) }, window.onresize = function () { e.$apply() }, e.selectedObject = void 0, e.selectedFields = [], e.selectObject = function (t) { e.selectedObject = t.Object, e.selectedFields = t.Object.fields, console.log(e.selectedObject) }, e.selectField = function (t) { e.selectedFields = [t], console.log(e.selectedFields) }, s.options(e, "fields-bag", { moves: function (e, t, o) { return o.classList.contains("fields-handle") } }), s.options(e, "main-bag", { moves: function (e, t, o) { return o.classList.contains("main-handle") } }), n() } angular.module("RDash").controller("MasterCtrl", ["$scope", "$cookieStore", "$http", "dragulaService", MasterCtrl]);
